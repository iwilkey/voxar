...
public class MainShader extends DefaultShader {
	...
	public static String getDefaultVertexShader () {
		if (defaultVertexShader == null)
			defaultVertexShader = Gdx.files.classpath("dev/iwilkey/voxar/gfx/shadows/system/classical/shaders/main.vertex.glsl")
			.readString();
	...
	public static String getDefaultFragmentShader () {
		if (defaultFragmentShader == null)
			defaultFragmentShader = Gdx.files.classpath("dev/iwilkey/voxar/gfx/shadows/system/classical/shaders/main.fragment.glsl")
			.readString();
